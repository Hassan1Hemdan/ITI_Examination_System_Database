CREATE PROCEDURE SP_Update_Intake
...
BEGIN
    ...
    DECLARE @SQL NVARCHAR(MAX) = 'UPDATE Intake SET ' + @ColumnUpdates;
...
EXEC SP_Update_Intake 
    @ColumnUpdates = N'End_Date = ''2025-12-31''',
    @Condition = N'Intake_ID = 12022';
